...
static void stellaris_init(const char *kernel_filename, const char *cpu_model,
                           stellaris_board_info *board)
{
    //Création des vecteurs des adresses d'interruption
    ...
    //Initialisation de ADC sur le GPIO &0x40038000
    if (board->dc1 & (1 << 16)) {
    ...
    //Initialisation des autres GPIO
    for (i = 0; i < 7; i++) {
        if (board->dc4 & (1 << i)) {
    ...
    //Initialisation de des GPIO - I2C
    if (board->dc2 & (1 << 12)) {
