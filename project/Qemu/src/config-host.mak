...
# Configured with: './configure' '--target-list=arm-softmmu' '--python=/usr/bin/python2.7'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
VNC_JPEG_CFLAGS=
CONFIG_VNC_PNG=y
VNC_PNG_CFLAGS=-I/usr/include/libpng15  
CONFIG_FNMATCH=y
CONFIG_UUID=y
CONFIG_XFS=y
VERSION=1.0
PKGVERSION=
SRC_PATH=/home/mickours/POLYTHEC_RICM4/Qemu/qemu_stm32L/rendu/Sources/Qemu/src
...
LIBTOOL=libtool
CFLAGS=-O2 -g 
QEMU_CFLAGS=-fPIE -DPIE -m64 -D_FORTIFY_SOURCE=2 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing  -fstack-protector-all -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -I/usr/include/libpng15   -I$(SRC_PATH)/libcacard -I/usr/include/nss -I/usr/include/nspr  
QEMU_INCLUDES=-I$(SRC_PATH)/slirp -I. -I$(SRC_PATH) -I$(SRC_PATH)/fpu
HELPER_CFLAGS=
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
ARLIBS_BEGIN=
ARLIBS_END=
LIBS+=-lssl3 -lsmime3 -lnss3 -lnssutil3 -lplds4 -lplc4 -lnspr4 -lpthread -ldl   -lrt -pthread -pthread -lgthread-2.0 -lrt -lglib-2.0   
LIBS_TOOLS+=-lcurl   -lvdeplug -luuid 
EXESUF=
